...
public class TeacherHandler {
  ...
  static String getDegreeText(int degree) {
    switch (degree) {
      case 1: return "고졸";
      case 2: return "전문학사";
      case 3: return "학사";
  ...
  void modifyTeacher() {
    ...
    m.setName(Prompt.inputString(String.format("이름(%s)? ", old.name)));
    m.setTel(Prompt.inputString(String.format("전화(%s)? ", old.tel)));
    m.setEmail(Prompt.inputString(String.format("우편번호(%s)? ", old.getEmail())));
