...
CREATE TABLE lms_addr (
	...
	basic_adrress VARCHAR(255) NOT NULL COMMENT '기본주소' -- 기본주소
)
COMMENT '기본주소';
...
CREATE TABLE lms_application (
	...
	application_statie_id VARCHAR(10) NULL     COMMENT '신청상태번호' -- 신청상태번호
)
COMMENT '수강신청';
...
CREATE TABLE lms_application_state (
	application_statie_id VARCHAR(10) NOT NULL COMMENT '신청상태번호', -- 신청상태번호
